 ...
 * can be used to handle validation easily from within models and pulling them
 * out of workers where appropriate.
 * @module astral:common:errors
 */
module.exports =
  class InvalidArgumentError extends AstralError {
    /**
