...
module.exports = class LaunchConfiguration {
  ...
  static create (name, options) {
    ...
    return Promise
      ...
      .then(aws.AutoScaling.createLaunchConfigurationAsync)
  ...
  static remove (name) {
    return Promise
      ...
      .then(aws.AutoScaling.deleteLaunchConfigurationAsync)
      .catch(Util.castAWSError);
  }
  ...
  static get (names, options) {
    ...
    return Promise
      ...
      .then(aws.AutoScaling.describeLaunchConfigurationsAsync)
      .catch(Util.castAWSError)
  }
};
